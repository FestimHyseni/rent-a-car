...
const Brands = () => {
  return (
    ...
    </section><section className="py-20 bg-slate-900 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-slate-800 rounded-2xl border border-slate-700">
              ...
              <p className="text-slate-300">Comprehensive insurance coverage for peace of mind</p>
            </div>
            <div className="p-6 bg-slate-800 rounded-2xl border border-slate-700">
              <Users className="w-12 h-12 text-purple-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">24/7 Support</h3>
              <p className="text-slate-300">Round-the-clock customer service and roadside assistance</p>
            </div>
            <div className="p-6 bg-slate-800 rounded-2xl border border-slate-700">
              <Award className="w-12 h-12 text-green-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Premium Fleet</h3>
              <p className="text-slate-300">Latest models with regular maintenance and updates</p>
            </div>
          </div>
        </div>
      </section></>
