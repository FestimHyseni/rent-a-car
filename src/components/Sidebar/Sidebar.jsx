...
const Sidebar = ({ activeTab, setActiveTab, sidebarOpen, setSidebarOpen, isLoaded }) => {
  ...
  const sidebarItems = [
    { id: 'dashboard', name: 'Dashboard', icon: BarChart3, gradient: 'from-indigo-600 to-blue-500', path: '/' },
    { id: 'cars', name: 'Makinat', icon: Car, gradient: 'from-purple-600 to-fuchsia-500', path: '/makinat' },
    { id: 'bookings', name: 'Rezervimet', icon: Calendar, gradient: 'from-emerald-600 to-teal-500', path: '/rezervimet' },
    { id: 'customers', name: 'Klientët', icon: Users, gradient: 'from-rose-600 to-pink-500', path: '/client' },
